...
try {
  ...
  try {
    ...
    if ($Uninstall) {
      ...
      @(
        (Join-Path $desktop 'Moonlit Cards Dream Skin.lnk'),
        (Join-Path $desktop 'Moonlit Cards Dream Skin - Restore.lnk'),
        (Join-Path $desktop 'Moonlit Cards Dream Skin - Tray.lnk'),
        (Join-Path $startMenu 'Moonlit Cards Dream Skin.lnk'),
        (Join-Path $startMenu 'Moonlit Cards Dream Skin - Tray.lnk'),
        (Join-Path $startup 'Moonlit Cards Dream Skin Auto Apply.lnk'),
    ...
    Write-Host 'Moonlit Cards restore completed; any saved CDP session was closed.'
} finally {
