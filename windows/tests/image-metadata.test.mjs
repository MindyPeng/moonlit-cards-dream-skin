...
const featured = await fs.readFile(path.join(windowsRoot, "assets", "moonlit-cards-original.png"));
...
const cli = spawnSync(process.execPath, [helper, "--check", path.join(windowsRoot, "assets", "moonlit-cards-original.png")], {
  encoding: "utf8",
});
